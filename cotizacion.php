...
// --------------------FIN SERVICIOS--------------------------------
        ...
        //MÁS INFORMACIÓN
        $extraInfo = $_POST['exampleFormControlTextarea1'];
...
//SENDING MAIL
    ...
    if (@mail($to, $correo, $message, $headers))
    {
        echo '<script>alert("Cotización enviada, en breve te contactaremos");</script>';
        header('Location: index.html');
    }else{
        echo '<script>alert("Ha ocurrido un error. Contáctanos al Tel: 656 603 6947");</script>';
    }
?>
